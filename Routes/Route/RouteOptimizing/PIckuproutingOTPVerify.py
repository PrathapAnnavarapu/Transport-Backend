...
from Routes.TripBilling.PickupTripBillings import calculate_fare_and_create_bill_for_pickup
...
@home.route('/employee/pickup/offboard', methods=['POST'])
def offboard_employee():
    data = request.json
    routing_id = data['routing_id']
    otp = data['otp']
    entered_by = data.get('entered_by')  # optional
